...
async function initDatabase() {
    ...
    if (process.env.NODE_ENV !== "production") {
        try {
            const connectionWithoutDb = await promise_1.default.createConnection({
                host: dbConfig.host,
                user: dbConfig.user,
            ...
            try {
                ...
                console.log("⚠️ Could not create database (may already exist or no permissions)");
            }
            finally {
...
async function seedDatabase() {
    ...
    try {
        ...
        await connection.query("INSERT INTO crusts (id, type, display_name, price_modifier) VALUES (?, ?, ?, ?)", ["crust-thick", "thick", "Thick Crust", 1.5]);
        await connection.query("INSERT INTO crusts (id, type, display_name, price_modifier) VALUES (?, ?, ?, ?)", ["crust-stuffed", "stuffed", "Stuffed Crust", 3.0]);
        // Insert toppings - Meats
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-pepperoni", "Pepperoni", 1.5, "meat"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-sausage", "Italian Sausage", 1.5, "meat"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-bacon", "Bacon", 1.75, "meat"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-ham", "Ham", 1.5, "meat"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-chicken", "Grilled Chicken", 2.0, "meat"]);
        // Veggies
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-mushroom", "Mushrooms", 1.0, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-onion", "Onions", 0.75, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-pepper", "Bell Peppers", 1.0, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-olive", "Black Olives", 1.0, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-tomato", "Fresh Tomatoes", 1.0, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-spinach", "Spinach", 1.25, "veggie"]);
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-jalapeno", "Jalapeños", 1.0, "veggie"]);
        // Cheese
        await connection.query("INSERT INTO toppings (id, name, price, category) VALUES (?, ?, ?, ?)", ["top-mozzarella", "Extra Mozzarella", 1.5, "cheese"]);
