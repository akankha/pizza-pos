              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('restaurant_city', e.target.value)}
                    required
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-orange-500 focus:outline-none"
            ...
            <div className="pt-6 border-t-2 border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('tax_label_gst', e.target.value)}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-orange-500 focus:outline-none"
                    placeholder="GST"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('gst_rate', parseFloat(e.target.value) / 100)}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-orange-500 focus:outline-none"
                    placeholder="5.00"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('tax_label_pst', e.target.value)}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-orange-500 focus:outline-none"
                    placeholder="PST"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('pst_rate', parseFloat(e.target.value) / 100)}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-orange-500 focus:outline-none"
                    placeholder="7.00"
                  />
                  <p className="text-xs text-gray-500 mt-1">
              ...
              <div className="mt-4 p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                <p className="text-sm text-blue-800">
                  <strong>Total Tax Rate:</strong> {((settings.gst_rate + settings.pst_rate) * 100).toFixed(2)}%
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  Example: $100.00 subtotal = ${((settings.gst_rate + settings.pst_rate) * 100).toFixed(2)} tax
                </p>
              </div>
            </div>
            ...
            <div className="pt-6 border-t-2 border-gray-200">
              ...
              <div className="mb-6 p-4 bg-gray-50 border-2 border-gray-200 rounded-xl">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-gray-700">Printer Status</p>
                    {printerStatus ? (
                      <p className={`text-sm mt-1 ${printerStatus.connected ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => handleChange('printer_enabled', e.target.checked)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('print_copies', parseInt(e.target.value))}
                    disabled={!settings.printer_enabled}
              ...
              <div className="mt-4 p-4 bg-purple-50 border-2 border-purple-200 rounded-xl">
                ...
                <p className="text-xs text-purple-600 mt-1">
                  80mm thermal printer connected via USB. Receipts will print automatically when orders are marked as "Ready" or "Completed".
                </p>
              </div>
            </div>
