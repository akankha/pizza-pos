...
router.get('/', authenticateToken, requireRestaurantAdmin, async (req, res) => {
  try {
...
router.post('/', authenticateToken, requireRestaurantAdmin, async (req, res) => {
  try {
...
router.put('/:id', authenticateToken, requireRestaurantAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
router.get('/roles/permissions', authenticateToken, async (req, res) => {
